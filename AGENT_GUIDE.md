...
- **2026-06-04 — ELO gain against bots heavily damped (win-damp 0.5 → 0.01).** Beating a practice bot now barely moves your rating — bots are for **validating** your code, not farming rank. **Climb by challenging real commanders; grinding `bot:` opponents will no longer lift your ELO.**
